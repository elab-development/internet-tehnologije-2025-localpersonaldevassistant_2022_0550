    ...
    <div className="flex flex-col gap-10 justify-center items-center w-full h-full">
      ...
      <div className="flex flex-col gap-5">
        <div className="flex items-center justify-baseline gap-3 text-white">
          ...
          <input onChange={(e) => setFullName(e.target.value)} id="fullname" className="w-80 border-2 rounded-2xl text-xl p-1 pl-3 outline-0" type="text" />
        </div>
        <div className="flex items-center justify-baseline gap-3 text-white">
          <label className="text-2xl font-bold" htmlFor="username">Username:</label>
          <input onChange={(e) => setUsername(e.target.value)} id="username" className="w-full border-2 rounded-2xl text-xl p-1 pl-3 outline-0" type="text" />
        </div>
        <div className="flex items-center justify-baseline gap-3 text-white">
          <label className="text-2xl font-bold" htmlFor="email">Email:</label>
          <input onChange={(e) => setFullName(e.target.value)} id="email" className="w-full border-2 rounded-2xl text-xl p-1 pl-3 outline-0" type="text" />
        </div>
        <div className="flex items-center justify-baseline gap-3 text-white">
